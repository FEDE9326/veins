...
WaveShortMessage::WaveShortMessage(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    ...
    this->serial = 0;
    this->timestamp = 0;
    this->AlertReceivedId = "Id alerts received";
}
...
void WaveShortMessage::copy(const WaveShortMessage& other)
{
    ...
    this->AlertReceivedId = other.AlertReceivedId;
}
...
void WaveShortMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->AlertReceivedId);
}
...
void WaveShortMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->AlertReceivedId);
}
...
std::string WaveShortMessage::getAlertReceivedId() const
{
    return this->AlertReceivedId.c_str();
}

void WaveShortMessage::setAlertReceivedId(std::string AlertReceivedId)
{
    this->AlertReceivedId = AlertReceivedId;
}
...
int WaveShortMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='A' && strcmp(fieldName, "AlertReceivedId")==0) return base+14;
...
std::string WaveShortMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 14: return oppstring2string(pp->getAlertReceivedId());
        default: return "";
    }
}
...
bool WaveShortMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 14: pp->setAlertReceivedId((value)); return true;
